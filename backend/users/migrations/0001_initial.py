        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(error_messages={
                    ...
                    verbose_name='Логин')),
                ('first_name',
                 models.CharField(blank=True, help_text='Укажите своё имя.',
                ...
                ('role', models.CharField(choices=[('moderator', 'Модератор'),
                                                   ('user', 'Пользователь'),
                                                   ('admin', 'Админ')],
                ...
                ('password',
                 models.CharField(help_text='Введите пароль.', max_length=150,
                                  verbose_name='Пароль')),
                ('groups',
